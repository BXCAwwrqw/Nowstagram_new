$(function () {
    ...
    function fInitialize() {
        ...
        var oListDv = $('#'+sImageId.toString()+'>ul.js-discuss-list');
            ...
            $.ajax({
                ...
                var sHtml = [
                    ...
                    '<li>',
                        ...
                        '<a class="_4zhc5 _iqaka" title="', that.encode(oResult.username), '" href="/profile/', oResult.user_id, '" data-reactid=".0.1.0.0.0.2.1.2:$comment-17856951190001917.1">', that.encode(oResult.username), '</a>',
                        '<span>',
                            '<span>', that.encode(sCmt), '</span>',
                        '</span>',
                    '</li>'].join('');
